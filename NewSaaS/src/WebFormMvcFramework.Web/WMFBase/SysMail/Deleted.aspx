<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deleted.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysMail.Deleted" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: right">
            <asp:LinkButton ID="lbut_Recovery" runat="server" class="button green" OnClick="lbut_Recovery_Click" OnClientClick="return GetCheckboxValue()"><span class="icon-botton"
            style="background: url('../../Themes/images/16/email_add.png') no-repeat scroll 0px 4px;">
        </span>恢 复</asp:LinkButton>
            <asp:LinkButton ID="lbut_Completelydelete" runat="server" class="button green" OnClick="lbut_Completelydelete_Click" OnClientClick="return GetCheckboxValue()"><span class="icon-botton"
            style="background: url('../../Themes/images/16/email_delete.png') no-repeat scroll 0px 4px;">
        </span>销 毁</asp:LinkButton>
        </div>
        <table id="table1" class="grid">
            <thead>
                <tr>
                    ...
                    <td style="width: 75%; text-align: left;">主题
                    </td>
