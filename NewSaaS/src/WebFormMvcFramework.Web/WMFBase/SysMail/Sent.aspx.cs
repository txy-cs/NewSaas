...
{
    public partial class Sent : PageBase
    {
        ...
        private void DataBindGrid()
        {
            ...
            SqlWhere.Append("  where(Mail_User_Account='" + RequestSession.GetSessionUser().UserAccount.ToString() + "' and Mail_DeleteMark=1 and Mail_Type=0)  ");
