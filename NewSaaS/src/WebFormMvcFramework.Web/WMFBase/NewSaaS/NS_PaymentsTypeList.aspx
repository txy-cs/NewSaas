<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_PaymentsTypeList.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_PaymentsTypeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        //新增
        function add() {
            var url = "../WMFBase/NewSaaS/NS_PaymentsTypeAdd.aspx";
            top.openDialog(url, 'NS_PaymentsTypeAdd', '科目类型 - 添加', 650, 150, 50, 50);
        }
        //编辑
        function Edit() {
            var key = CheckboxValue();
            if (key != "") {
                var url = "../WMFBase/NewSaaS/NS_PaymentsTypeEdit.aspx?Key=" + key + "";
                top.openDialog(url, 'NS_PaymentsTypeEdit', '科目类型 - 编辑', 650, 150, 50, 50);
            }
            else {
            ...
            <table id="table1" class="grid" singleselect="true">
                <thead>
                    <tr>
                        ...
                        <td style="width: 30%; text-align: center;">名称
                        </td>
