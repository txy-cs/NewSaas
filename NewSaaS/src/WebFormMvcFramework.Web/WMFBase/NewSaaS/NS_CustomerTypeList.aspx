<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_CustomerTypeList.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_CustomerTypeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        //新增
        function add() {
            var url = "../WMFBase/NewSaaS/NS_CustomerTypeAdd.aspx";
            top.openDialog(url, 'NS_CustomerTypeAdd', '客户类型 - 添加', 650, 150, 50, 50);
        }
        //编辑
        function Edit() {
            var key = CheckboxValue();
            if (key != "") {
                var url = "../WMFBase/NewSaaS/NS_CustomerTypeEdit.aspx?Key=" + key + "";
                top.openDialog(url, 'NS_CustomerTypeEdit', '客户类型 - 编辑', 650, 150, 50, 50);
            }
            else {
