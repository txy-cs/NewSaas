...
{
    public partial class NS_PaymentsTypeList : System.Web.UI.Page
    {
        ...
        private void DataBindGrid()
        {
            ...
            SqlWhere.Append(" select * from SaaS_PaymentsType where(u_guid='" + HttpContext.Current.Session["u_UserParent"].ToString() + "' and p_name like '%" + u_select.Value + "%') ");
        ...
        {
            StringBuilder SqlWhere = new StringBuilder();
            SqlWhere.Append(" delete from SaaS_PaymentsType where(p_guid='" + hf_p_guid.Value + "') ");
