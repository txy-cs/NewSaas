<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_SupplierEdit.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_SupplierEdit" %>
    ...
    <form id="form1" runat="server">
        <div class="auto-style2">
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                ...
                <tr>
                    <th>联系人:</th>
                    <td><input id="s_contacts" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>联系手机:</th>
                    <td>
                        <input id="s_Phone" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                <tr>
                    <th>联系电话:</th>
                    <td><input id="s_ContactPhone" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>QQ:</th>
                    <td>
                        <input id="s_QQ" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                <tr>
                    <th>主营业务:</th>
                    <td><input id="s_MainBusiness" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                    <th>地址:</th>
                    <td>
                        <input id="s_address" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                <tr>
                    <th>备注:</th>
                    <td><input id="s_Remarks" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>总计欠款:</th>
                    <td>
                        <input id="s_Arrears" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" value="0" /></td>
                </tr>
                </table>
        </div>
