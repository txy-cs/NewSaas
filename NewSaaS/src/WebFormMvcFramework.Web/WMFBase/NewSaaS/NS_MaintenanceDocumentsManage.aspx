<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_MaintenanceDocumentsManage.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_MaintenanceDocumentsManage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="auto-style10">
            <div style="float: right;">
                &nbsp;<asp:LinkButton ID="lbtUserSel" runat="server" class="button green">保 存</asp:LinkButton>
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="auto-style1">
                <tr>
                    ...
                    <td class="auto-style3">
                        <input id="m_LatestMileage" runat="server" type="text" class="txt" datacol="yes" err="商品编码"
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <input id="w_Company" runat="server" type="text" class="txt" datacol="yes" err="接待人员"
                            checkexpession="NotNull" style="width: 200px" /></td>
