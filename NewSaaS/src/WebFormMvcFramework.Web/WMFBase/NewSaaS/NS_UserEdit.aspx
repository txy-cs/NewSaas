<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_UserEdit.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_UserEdit" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <script type="text/javascript">
      function verification() {
          if ($("#u_user").val() == "") {
              showWarningMsg("填写登录账户！");
              return false;
          }
          if ($("#u_pwd").val() == "") {
              showWarningMsg("填写登录密码！");
              return false;
          }
          return true;
      }
        ...
        <div class="auto-style2">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    ...
                    <td>&nbsp;<input id="u_user" disabled runat="server" type="text" class="txt" datacol="yes" err="登录账户"
                        checkexpession="NotNull" style="width: 200px" aria-disabled="True" /></td>
                    <th>登录密码:
                    </th>
                    <td>
                        &nbsp;<input id="u_pwd" runat="server" type="text" class="txt" err="登录密码"
