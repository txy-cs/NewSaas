<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_UserAdd.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_UserAdd" %>
        ...
        <div class="auto-style2">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    ...
                    <td>&nbsp;<input id="u_user" runat="server" type="text" class="txt" datacol="yes" err="登录账户"
