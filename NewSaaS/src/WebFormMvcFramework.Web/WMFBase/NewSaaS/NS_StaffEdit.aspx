<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_StaffEdit.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_StaffEdit" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div-frm" style="height: 275px;">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    ...
                    <td>
                        &nbsp;<input id="u_Name" disabled runat="server" type="text" class="txt" err="职工姓名"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                <tr>
                    <th>账户性别:
                ...
                <tr>
                    ...
                    <td>
                        <input id="u_IDCardNumber" disabled runat="server" type="text" class="txt" style="width: 200px" />
                    </td>
                    <th>入职日期:
                    </th>
                    <td>
                          <input type="text" disabled id="u_EntryDate" datacol="yes" class="txt" runat="server" style="width: 200px;"
                ...
                <tr>
                    <th>出生年月: </th>
                    <td>
                        <input type="text" disabled id="u_Birthday" datacol="yes" class="txt" runat="server" style="width: 200px;"
                            onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 00:00:00' })" />
                    </td>
                    <th>&nbsp;</th>
                    <td>
        ...
        <div class="frmbottom">
            <asp:LinkButton ID="Save" runat="server"  OnClientClick="return verification();" class="l-btn" OnClick="Save_Click"><span class="l-btn-left">
