...
{
    public partial class NS_StaffList : System.Web.UI.Page
    {
        ...
        private void DataBindGrid()
        {
            ...
            SqlWhere.Append("    WHERE(  u_Name LIKE '%" + u_select.Value + "%'   ");
        ...
        protected void lbtUserDel_Click(object sender, EventArgs e)
        {
            ...
            {
                StringBuilder SqlWhere = new StringBuilder();
                SqlWhere.Append(" delete from SaaS_User where(u_guid='" + hf_U_Guid.Value + "') ");
            ...
            {
                ShowMsgHelper.Alert_Error("删除失败！");
            }
        }
    }
}