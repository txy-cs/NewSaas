<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_ToolAdd.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_ToolAdd" %>
    ...
    <form id="form1" runat="server">
        <div class="auto-style2">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    <th>名称: </th>
                    <td><input id="c_name" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>购买价格:
                    </th>
                    <td>
                        <input id="c_PurchasePrice" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                <tr>
                    <th>购买时间:</th>
                    <td><input id="c_BuyingTime" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px"  onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 00:00:00' })" /></td>
                    <th>备注:</th>
                    <td>
                        <input id="c_Remarks" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                </table>
        </div>
