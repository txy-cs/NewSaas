<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_UserList.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_UserList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function add() {
            ...
            if (key != "") {
                var url = "../WMFBase/NewSaaS/NS_UserAdd.aspx?Key=" + key + "";
                top.openDialog(url, 'NS_UserAdd', '用户信息 - 添加', 650, 150, 50, 50);
            }
            else {
                showTipsMsg("选择新增用户！", 2000, 4);
            }
        }
        //编辑
        function Edit() {
            var key = CheckboxValue();
            if (key != "") {
                var url = "../WMFBase/NewSaaS/NS_UserEdit.aspx?Key=" + key + "";
                top.openDialog(url, 'NS_UserEdit', '用户信息 - 编辑', 650, 150, 50, 50);
            }
            else {
    ...
    <form id="form1" runat="server" onload="Page_Load">
        ...
        <div class="btnbarcontetn">
            <div style="float: right;">
                ...
                <asp:LinkButton ID="lbtUserAdd" runat="server" class="button green" OnClientClick="add()" >新增帐号</asp:LinkButton>
                  <asp:LinkButton ID="lbtUserEdit" runat="server" class="button green" OnClientClick="Edit()">编 辑</asp:LinkButton>
                <asp:LinkButton ID="lbtUserDel" runat="server" class="button green" OnClientClick="return Delete();" OnClick="lbtUserDel_Click">删除帐号</asp:LinkButton>
            </div>
        </div>
        <div class="div-body">
            <table id="table1" class="grid" singleselect="true">
                <thead>
                    <tr>
                        ...
                        <td style="width: 60px; text-align: center;">账户
                        </td>
