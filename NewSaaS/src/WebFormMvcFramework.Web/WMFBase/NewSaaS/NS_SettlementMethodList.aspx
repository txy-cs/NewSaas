<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_SettlementMethodList.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_SettlementMethodList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        //新增
        function add() {
            var url = "../WMFBase/NewSaaS/NS_SettlementMethodAdd.aspx";
            top.openDialog(url, 'NS_SettlementMethodAdd', '结算方式 - 添加', 650, 150, 50, 50);
        }
        //编辑
        function Edit() {
            var key = CheckboxValue();
            if (key != "") {
                var url = "../WMFBase/NewSaaS/NS_SettlementMethodEdit.aspx?Key=" + key + "";
                top.openDialog(url, 'NS_SettlementMethodEdit', '结算方式 - 编辑', 650, 150, 50, 50);
            }
            else {
