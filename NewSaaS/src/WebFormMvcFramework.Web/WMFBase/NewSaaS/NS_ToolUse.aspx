<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_ToolUse.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_ToolUse" %>
        ...
        <div class="auto-style2">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    <th>领用人: </th>
                    <td>
                        <asp:DropDownList ID="c_LeadingPerson" runat="server" class="txt" style="width: 205px;height:25px"  ></asp:DropDownList>
                    </td>
                    <th>领用时间: </th>
                    <td>
                        &nbsp;<input id="c_LeadTime" runat="server" type="text" class="txt" err="领用时间"
                            checkexpession="NotNull" style="width: 200px" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd 00:00:00' })" /></td>
                </tr>
                <tr>
                    <th>备注:</th>
                    <td><input id="c_Remarks" runat="server" type="text" class="txt" datacol="yes" err="备注"
