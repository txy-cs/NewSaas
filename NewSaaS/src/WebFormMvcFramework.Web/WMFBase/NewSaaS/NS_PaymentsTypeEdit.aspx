<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_PaymentsTypeEdit.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_PaymentsTypeEdit" %>
    ...
    <form id="form1" runat="server">
        <div class="auto-style2">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    <th>序号: </th>
                    <td><input id="p_number" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>科目名称:
                    </th>
                    <td>
                        &nbsp;<input id="p_name" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                <tr>
                    <th>备注:</th>
                    <td><input id="p_Remarks" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>&nbsp;</th>
                    <td>
                        &nbsp;</td>
