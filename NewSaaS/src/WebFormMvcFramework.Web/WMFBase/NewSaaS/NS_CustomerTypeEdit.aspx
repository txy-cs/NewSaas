<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NS_CustomerTypeEdit.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.NewSaaS.NS_CustomerTypeEdit" %>
    ...
    <form id="form1" runat="server">
        <div class="auto-style2">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                <tr>
                    <th>序号: </th>
                    <td>&nbsp;<input id="c_number" runat="server" type="text" class="txt" datacol="yes" err="序号"
                        checkexpession="NotNull" style="width: 200px" /></td>
                    <th>名称:
                    </th>
                    <td>
                        &nbsp;<input id="c_name" runat="server" type="text" class="txt" err="名称"
                            checkexpession="NotNull" style="width: 200px" /></td>
                </tr>
                </table>
        </div>
