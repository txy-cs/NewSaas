<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_List.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysMenu.Menu_List1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "../WMFBase/SysMenu/Menu_Form.aspx?ParentId=" + Menu_Id;
        ...
        function edit() {
            var key = Menu_Id;
            if (IsEditdata(key)) {
                var url = "../WMFBase/SysMenu/Menu_Form.aspx?key=" + key;
        ...
        function allotButton() {
            var key = Menu_Id;
            if (IsEditdata(key)) {
                var url = "../WMFBase/SysMenu/AllotButton_Form.aspx?key=" + key;
    ...
    <form id="form1" runat="server" onload="Page_Load"> 
        ...
        <div class="div-body">
            <table class="example" id="dnd-example">
                <thead>
                    <tr>
                        <td style="width: 230px; padding-left: 20px;">菜单名称
                        </td>
