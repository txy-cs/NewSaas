<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroup_Form.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysUserGroup.UserGroup_Form" %>
    ...
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            ...
            <tr>
                ...
                <td>
                    <textarea id="UserGroup_Remark" class="txtRemark" runat="server" style="width: 85.5%; height: 80px;"></textarea>
                </td>
            </tr>
        </table>
        <div class="frmbottom">
