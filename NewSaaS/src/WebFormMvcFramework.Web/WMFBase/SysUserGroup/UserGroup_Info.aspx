<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroup_Info.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysUserGroup.UserGroup_Info" %>
    ...
    <form id="form1" runat="server" onload="Page_Load">
        ...
        <div class="btnbarcontetn">
            ...
            <div style="text-align: right">
                <a href="javascript:void(0)" title="返 回" onclick="back();" class="button green"><span
                    class="icon-botton" style="background: url('../../Themes/images/16/back.png') no-repeat scroll 0px 4px;"></span>返 回</a>
            </div>
        </div>
        <div class="div-body" id="div_Left">
            <table class="example" id="dnd-example">
                <thead>
                    <tr>
                        <td style="width: 200px; padding-left: 20px;">URL菜单权限
                        </td>
