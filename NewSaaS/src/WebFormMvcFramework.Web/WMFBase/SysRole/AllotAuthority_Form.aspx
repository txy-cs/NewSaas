<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotAuthority_Form.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysRole.AllotAuthority_Form" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //返回
        function back() {
            Urlhref('<%=WebFormMvcFramework.Common.DotNetConfig.ConfigHelper.GetAppSettings("VirtualDirectory") %>WMFBase/SysRole/Role_List.aspx');
        }
        //保存
        function SaveForm() {
