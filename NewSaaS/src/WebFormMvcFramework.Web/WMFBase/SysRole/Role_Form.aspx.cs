...
namespace WebFormMvcFramework.Web.WMFBase.SysRole
{
    public class Role_Form : PageBase
    {
        ...
        {
            Hashtable ht = system_idao.GetHashtableById("Base_Roles", "Roles_ID", this._key);
        ...
        protected void Save_Click(object sender, EventArgs e)
        {
            ...
            bool IsOk = system_idao.Submit_AddOrEdit("Base_Roles", "Roles_ID", this._key, ht);
            if (IsOk)
            {
