<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Button_Form.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysMenu.Button_Form" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SelectOpenImg() {
            var url = "../WMFBase/SysMenu/Icons_List.aspx?Size=16";
    ...
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            ...
            <tr>
                ...
                <td>
                    <textarea id="Button_Code" class="txtRemark" runat="server" style="width: 85.5%; height: 50px;"></textarea>
                </td>
            </tr>
            <tr>
                <th>说明：
                ...
                <td>
                    <textarea id="Button_Remak" class="txtRemark" runat="server" style="width: 85.5%; height: 50px;"></textarea>
                </td>
            </tr>
        </table>
        <div class="frmbottom">
