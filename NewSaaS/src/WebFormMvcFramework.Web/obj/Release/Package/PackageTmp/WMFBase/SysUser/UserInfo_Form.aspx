<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_Form.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysUser.UserInfo_Form" %>
        ...
        <div class="div-frm" style="height: 275px;">
            ...
            <table id="table1" border="0" cellpadding="0" cellspacing="0" class="frm">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <textarea id="User_Remark" class="txtRemark" runat="server" style="width: 552px; height: 83px;"></textarea>
                    </td>
                </tr>
            </table>
            <%--所属部门--%>
