<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Role_Form.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysRole.Role_Form" %>
    ...
    <form id="form1" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            ...
            <tr>
                ...
                <td>
                    <textarea id="Roles_Remark" class="txtRemark" runat="server" style="width: 85.5%; height: 170px;"></textarea>
                </td>
            </tr>
        </table>
        <div id="UserInfolist">
