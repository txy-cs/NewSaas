<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotButton_Form.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysMenu.AllotButton_Form" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Buttonlist">
            <div id="Buttonlistleft" style="float: left; width: 48.6%; border: 1px solid #ccc; margin-right: 5px;">
                <div class="box-title" style="height: 25px;">
                    所有按钮;<span style="color: Blue;">双击添加</span>
                </div>
                <div class="div-overflow" id="allButton" style="overflow-x: hidden; overflow-y: scroll; margin-bottom: 5px;">
                    <%=ButtonList.ToString() %>
                </div>
            </div>
            <div id="Buttonlistright" style="float: left; width: 48.6%; border: 1px solid #ccc;">
                ...
                <div class="div-overflow" id="selectedButton" style="overflow-x: hidden; overflow-y: scroll; margin-bottom: 5px;">
