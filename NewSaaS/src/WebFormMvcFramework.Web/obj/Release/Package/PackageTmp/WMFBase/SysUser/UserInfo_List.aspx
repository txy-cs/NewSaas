<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_List.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysUser.UserInfo_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //导入
        function UserInport() {
            var url = "../WMFBase/SysUser/UserInfo_Import.aspx";
            top.openDialog(url, 'UserInfo_Import', '用户信息 - 导入', 350, 150, 50, 50);
        }
        //导出
        function UserExport() {
            var url = "../WMFBase/SysUser/UserInfo_Export.aspx";
            top.openDialog(url, 'UserInfo_Export', '用户信息 - 导出', 300, 100, 50, 50);
        }
        //添加
        function add() {
            var url = "../WMFBase/SysUser/UserInfo_Form.aspx";
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "../WMFBase/SysUser/UserInfo_Form.aspx?key=" + key;
            ...
            <table id="table1" class="grid" singleselect="true">
                <thead>
                    <tr>
                        ...
                        <td style="width: 60px; text-align: center;">职工工号
                        </td>
                        <td style="width: 80px; text-align: center;">用户姓名
                        </td>
                        <td style="width: 100px; text-align: center;">登录账户
                        </td>
                        <td style="width: 50px; text-align: center;">性别
                        </td>
                        <td style="width: 200px; text-align: center;">职称
                        </td>
