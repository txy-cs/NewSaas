<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OperationList.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysLog.OperationList" %>

<%@ Register Src="~/UserControl/Paging.ascx" TagName="Paging" TagPrefix="uc1" %>
                ...
                <table style="padding: 0px; margin: 0px; height: 100%;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td id="menutab" style="vertical-align: bottom;">
                            ...
                            <div id="tab0" class="Tabremovesel" onclick="GetTabClick(this);Urlhref('AbnormalList.aspx');">
                                异常日志
                            </div>
                            <div id="Div1" class="Tabsel" onclick="GetTabClick(this);Urlhref('OperationList.aspx');">
                                操作日志
                            </div>
                        </td>
                    </tr>
            ...
            <table id="table1" class="grid">
                <thead>
                    <tr>
                        ...
                        <td style="width: 30px; text-align: center;">序号
                        </td>
                        <td style="width: 50px; text-align: center;">操作账户
                        </td>
                        <td style="width: 50px; text-align: center;">操作日期
                        </td>
                        <td style="width: 150px; text-align: center;">模块名称
                        </td>
                        <td style="width: 150px; text-align: center;">功能名称
                        </td>
                    </tr>
                </thead>
                <tbody>
                    <asp:Repeater ID="rp_Item" runat="server" OnItemDataBound="rp_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                <td style="width: 20px; text-align: left;">
                                    <input type="checkbox" value="<%#Eval("SYS_OperationLog_ID")%>" name="checkbox" />
                                </td>
                                ...
                                <td style="width: 50px; text-align: center;">
                                    <%#Eval("SYS_OperationLog_TIME")%>
                                </td>
                                <td style="width: 150px; text-align: center;">
                                    <%#Eval("SYS_OperationLog_Modular")%>
                                </td>
                                <td style="width: 150px; text-align: center;">
                                    <%#Eval("SYS_OperationLog_Function")%>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
