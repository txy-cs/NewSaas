<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu_Form.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysMenu.Menu_Form" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SelectOpenImg() {
            var url = "../WMFBase/SysMenu/Icons_List.aspx?Size=32";
