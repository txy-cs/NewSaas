<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroup_List.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysUserGroup.UserGroup_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "../WMFBase/SysUserGroup/UserGroup_Form.aspx?ParentId=" + UserGroup_ID;
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "../WMFBase/SysUserGroup/UserGroup_Form.aspx?key=" + key;
        ...
        function allotMember() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "../WMFBase/SysUserGroup/UserGroupSet.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
        ...
        function allotAuthority() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "<%=WebFormMvcFramework.Common.DotNetConfig.ConfigHelper.GetAppSettings("VirtualDirectory") %>WMFBase/SysUserGroup/AllotAuthority_Form.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
                Urlhref(url);
            }
        }
        //详细信息
        function detail() {
            if (IsEditdata(UserGroup_ID)) {
                var url = "<%=WebFormMvcFramework.Common.DotNetConfig.ConfigHelper.GetAppSettings("VirtualDirectory") %>WMFBase/SysUserGroup/UserGroup_Info.aspx?UserGroup_ID=" + UserGroup_ID + '&UserGroup_Name=' + escape(UserGroup_Name);
                Urlhref(url);
            }
        }
    </script>
    ...
    <form id="form1" runat="server">
        ...
        <div class="div-body">
            <table class="example" id="dnd-example">
                <thead>
                    <tr>
                        <td style="width: 180px; padding-left: 20px;">用户组名称
                        </td>
                        <td style="width: 60px; text-align: center;">用户组编号
                        </td>
                        <td style="width: 60px; text-align: center;">显示顺序
                        </td>
                        <td style="width: 120px; text-align: center;">创建用户
                        </td>
                        <td style="width: 120px; text-align: center;">创建时间
                        </td>
                        <td style="width: 120px; text-align: center;">修改用户
                        </td>
                        <td style="width: 120px; text-align: center;">修改时间
                        </td>
                        <td>描述信息
                        </td>
                    </tr>
