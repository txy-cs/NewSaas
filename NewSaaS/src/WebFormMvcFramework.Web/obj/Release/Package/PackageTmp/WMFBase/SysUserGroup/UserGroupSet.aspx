<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserGroupSet.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysUserGroup.UserGroupSet" %>
        ...
        <div id="UserInfolist" style="height: 470px;">
                    ...
                    <table id="table1" class="grid">
                        <thead>
                            <tr>
                                ...
                                <td style="width: 100px; border-right: 0px; text-align: center;">登录账户
                                </td>
                            </tr>
                        </thead>
            ...
            <div style="float: left; width: 8%; text-align: center; padding-top: 200px;">
                <a onclick="addMember()" class="button green" title="添加用户到组"><span class="icon-botton"
                    style="background: url('../../Themes/images/arrow_right.png') no-repeat scroll 5px 4px;"></span></a>
            </div>
