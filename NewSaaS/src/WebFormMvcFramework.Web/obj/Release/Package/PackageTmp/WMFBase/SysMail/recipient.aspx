<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recipient.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysMail.recipient" %>
        ...
        <table id="table1" class="grid">
            <thead>
                <tr>
                    ...
                    <td style="width: 15%; text-align: center;">发件人
                    </td>
                    <td style="width: 60%; text-align: left;">主题
                    </td>
                    <td style="width: 15%; text-align:left;">时间
                    </td>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="width: 60%; text-align: left;">
                                <asp:LinkButton ID="lb_Details" runat="server" PostBackUrl=<%# "~/WMFBase/SysMail/Details.aspx?Mail_Guid="+Eval("Mail_Guid") %>> <%#Eval("Mail_Name")%></asp:LinkButton>
                            </td>
