<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbnormalList.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysLog.AbnormalList" %>
                ...
                <table style="padding: 0px; margin: 0px; height: 100%;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td id="menutab" style="vertical-align: bottom;">
                            ...
                            <div id="tab0" class="Tabsel" onclick="GetTabClick(this);Urlhref('AbnormalList.aspx');">
                                异常日志
                            </div>
                            <div id="Div1" class="Tabremovesel" onclick="GetTabClick(this);Urlhref('OperationList.aspx');">
                                操作日志
                            </div>
                        </td>
                    </tr>
            ...
            <table id="table1" class="grid">
                <thead>
                    <tr>
                        ...
                        <td style="width: 150px; text-align: center;">登录日期
                        </td>
                        <td style="width: auto; text-align: center;">异常信息
                        </td>
                    </tr>
                </thead>
                <tbody>
                    <asp:Repeater ID="rp_Item" runat="server" OnItemDataBound="rp_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                <td style="width: 20px; text-align: left;">
                                    <input type="checkbox" value="<%#Eval("SYS_AbnormaLog_ID")%>" name="checkbox" />
                                </td>
                                ...
                                <td style="width: 150px; text-align: center;">
                                    <%#Eval("SYS_AbnormaLog_TIME")%>
                                </td>
                                <td style="width: auto; text-align: left;">
                                    <%#Eval("SYS_Abnorma_Information")%>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
