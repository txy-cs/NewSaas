<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organization_List.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysOrg.Organization_List" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        **/
        ...
        //新增
        function add() {
            var url = "../WMFBase/SysOrg/Organization_Form.aspx?ParentId=" + Organization_ID;
        ...
        function edit() {
            ...
            if (IsEditdata(key)) {
                var url = "../WMFBase/SysOrg/Organization_Form.aspx?key=" + key;
    ...
    <form id="form1" runat="server">
        ...
        <div class="div-body">
            <table class="example" id="dnd-example">
                <thead>
                    <tr>
                        <td style="width: 120px; padding-left: 20px;">组织机构
                        </td>
                        <td style="width: 50px; text-align: center;">部门编号
                        </td>
                        <td style="width: 100px; text-align: center;">主负责人
                        </td>
                        <td style="width: 100px; text-align: center;">外线电话
                        </td>
                        <td style="width: 100px; text-align: center;">内线电话
                        </td>
                        <td style="width: 100px; text-align: center;">传真号码
                        </td>
                        <td style="width: 50px; text-align: center;">邮政区号
                        </td>
