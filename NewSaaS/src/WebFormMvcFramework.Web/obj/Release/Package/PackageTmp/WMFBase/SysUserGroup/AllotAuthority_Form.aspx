<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllotAuthority_Form.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysUserGroup.AllotAuthority_Form" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //返回
        function back() {
            Urlhref('<%=WebFormMvcFramework.Common.DotNetConfig.ConfigHelper.GetAppSettings("VirtualDirectory") %>WMFBase/SysUserGroup/UserGroup_List.aspx');
        }
        //保存
        function SaveForm() {
    ...
    <form id="form1" runat="server">
        ...
        <div class="div-body">
            <table class="example" id="dnd-example">
                <thead>
                    <tr>
                        <td style="width: 203px; padding-left: 20px;">URL菜单权限
                        </td>
