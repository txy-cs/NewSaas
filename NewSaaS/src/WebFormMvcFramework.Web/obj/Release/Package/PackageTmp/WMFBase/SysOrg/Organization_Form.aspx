<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organization_Form.aspx.cs"
    Inherits="WebFormMvcFramework.Web.WMFBase.SysOrg.Organization_Form" %>
    ...
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" class="frm">
            ...
            <tr>
                ...
                <td colspan="3">
                    <textarea id="Organization_Remark" class="txtRemark" runat="server" style="width: 552px; height: 100px;"></textarea>
                </td>
            </tr>
        </table>
        <div class="frmbottom">
