<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Button_List.aspx.cs" Inherits="WebFormMvcFramework.Web.WMFBase.SysMenu.Button_List" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function add() {
            var url = "../WMFBase/SysMenu/Button_Form.aspx";
        ...
        function edit() {
            ...
            if (IsEditdata(CheckboxValue())) {
                var url = "../WMFBase/SysMenu/Button_Form.aspx?key=" + key;
            ...
            <table id="table1" class="grid" singleselect="true">
                <thead>
                    <tr>
                        ...
                        <td style="width: 35px; text-align: center;">图标
                        </td>
                        <td style="width: 80px; text-align: center;">名称
                        </td>
                        <td style="width: 60px; text-align: center;">位置
                        </td>
                        <td style="width: 120px;">事件
                        </td>
                        <td style="width: 50px; text-align: center;">显示顺序
                        </td>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: 35px; text-align: center;">
                                    <img src='../../Themes/images/16/<%#Eval("Button_Img")%>' style='width: 16px; height: 16px; vertical-align: middle;'
                                        alt='' />
                                </td>
