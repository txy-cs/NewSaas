                    ...
                    <ContentTemplate>
                        ...
                        <div id="conten_title">
                            ...
                            <div id="toolbar" style="text-align: right; padding-right: 3px;">
                                <img id="NewMail" runat="server" src="../Themes/Images/Mail.gif" title="新邮件" alt=""
                                    width="20" height="20" style="padding-bottom: 1px; cursor: pointer; vertical-align: middle;" visible="false" />
                                &nbsp;&nbsp;&nbsp;
                                <img src="../Themes/Images/UpPwd.png" title="修改登录密码" alt="" onclick="editpwd()"
