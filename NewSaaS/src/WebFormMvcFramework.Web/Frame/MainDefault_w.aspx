<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainDefault_w.aspx.cs" Inherits="WebFormMvcFramework.Web.Frame.MainDefault_w" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetSeedMenu(e, menu_id) {
            ...
            for (var i = 0; i < json.MENU.length; i++) {
                ...
                if (menu.PARENTID == menu_id) {
                    $("#htmlMenuPanel").append("<div onclick=\"NavMenu('" + menu.NAVIGATEURL + "','" + menu.MENU_NAME + "')\">" + menu.MENU_NAME + "</div>");
                }
            }
            readyIndex();
        }
        ...
        /**修改密码**/
        function editpwd() {
            var url = "../WMFBase/SysUser/UpdateUserPwd.aspx";
            ...
            <div id="Headerbotton">
                    ...
                    <ContentTemplate>
                        <div id="conten_title">
                            ...
                            <div id="toolbar" style="text-align: right; padding-right: 3px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <img src="../Themes/Images/UpPwd.png" title="修改登录密码" alt=""
                                    width="20" height="20" style="padding-bottom: 1px; cursor: pointer; vertical-align: middle;" onclick="editpwd()" />
                                &nbsp;&nbsp;&nbsp;
                ...
                <div id="MainContent">
                    <div class="navigation" id="navigation" style="padding-top: 1px;">
                        ...
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/wx.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;维修</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/cg.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;采购</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/gj.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;工具</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/zl.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;资料</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/bb.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;报表</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/tj.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;统计</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/bz.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;帮助</span>                          
                        </div>
                        <div  onmouseover="this.style.backgroundColor='#EEE8AA'" onmouseout="this.style.backgroundColor='#FFFFFF'" 
                            alt="" style="text-align:left;font-weight:bold; cursor: pointer;padding-top: 7.5px; padding-bottom:7.5px" onclick="editpwd();"> <!--added by myself-->
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="../Themes/Images/Direction/znx.png" 
                                    width="20" height="20" style=" vertical-align: middle;font-weight:bold;" />
                            <span>&nbsp;&nbsp;站内信</span>                          
                        </div>
