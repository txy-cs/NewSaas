...
namespace WebFormMvcFramework.Common.DotNetCode
{
    public class RequestHelper
    {
        ...
        public static string GetScriptName
        {
            get
            {
                int i=HttpContext.Current.Request.ServerVariables["SCRIPT_NAME"].ToString().IndexOf("WMFBase");
                return ".." + HttpContext.Current.Request.ServerVariables["SCRIPT_NAME"].ToString().Substring(i - 1);
            }
        }
